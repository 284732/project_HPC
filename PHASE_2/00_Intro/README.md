...
Per affrontare questi vincoli, in HPC ci si affida a linguaggi capaci di produrre codice macchina fortemente ottimizzato, con overhead di runtime minimo o nullo rispetto a un'implementazione equivalente scritta direttamente in linguaggio macchina. Il C++ moderno (a partire dallo standard C++11 e successivi) offre, in questo senso, un insieme di caratteristiche particolarmente rilevanti:
