...
* **Programmazione generica tramite template.** I template C++ permettono di scrivere codice numerico generico rispetto al tipo di dato (`float`, `double`, tipi custom per precisione estesa).
